...
chansons = sp.current_user_top_tracks(limit=25, time_range='medium_term')
...
chansons = sp.current_user_top_tracks(limit=25, time_range='long_term')
...
f = open("25_long_term_songs.json", "w", encoding='utf8')
f.write(json_out)
f.close()
