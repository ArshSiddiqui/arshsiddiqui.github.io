...
res = requests.get(f'https://ws.audioscrobbler.com/2.0/?method=user.gettoptracks&user={userName}&api_key={apiKey}&period=1month&limit=10&format=json')
res.encoding = 'utf-8'
response = json.loads(res.text)
...
f = open("last_month_scrobble.json", 'w', encoding='utf8')
f.write(str(json_out))
f.close()

res = requests.get(f'https://ws.audioscrobbler.com/2.0/?method=user.gettoptracks&user={userName}&api_key={apiKey}&period=12month&limit=20&format=json')
res.encoding = 'utf-8'
response = json.loads(res.text)
...
res = requests.get(f'https://ws.audioscrobbler.com/2.0/?method=user.gettoptracks&user={userName}&api_key={apiKey}&period=overall&limit=20&format=json')
res.encoding = 'utf-8'
response = json.loads(res.text)
